...
| File | Best for |
| --- | --- |
| `Pineria.Setup.0.1.1.exe` | Most people. Installs normally, adds Start Menu and desktop shortcuts, uninstalls cleanly. |
| `Pineria.Portable.0.1.1.exe` | Running from a USB stick, or trying it without installing anything. |
